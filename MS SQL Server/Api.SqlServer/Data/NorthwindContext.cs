    ...
    public partial class NorthwindContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Ndbang>(entity =>
            {
                ...
                entity.ToTable("NDBang");

                entity.Property(e => e.Idbang)
                    .HasMaxLength(50)
                    .IsUnicode(false)
                    .HasColumnName("IDBang");

                entity.Property(e => e.Vtcot)
                    .HasMaxLength(50)
                    .IsUnicode(false)
                    .HasColumnName("VTCot");

                entity.Property(e => e.Vtdong)
                    .HasMaxLength(50)
                    .IsUnicode(false)
                    .HasColumnName("VTDong");
                ...
                entity.HasOne(d => d.IdbangNavigation)
                    .WithMany(p => p.Ndbangs)
                    .HasForeignKey(d => d.Idbang)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_NDBang_Bang");
            });
