    ...
    public partial class NorthwindContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Bang>(entity =>
            {
                ...
                entity.Property(e => e.SoDong).HasColumnName("So_Dong");

                entity.Property(e => e.TenBan).HasColumnName("Ten_Ban");
            });
            ...
            modelBuilder.Entity<NdBang>(entity =>
            {
                entity.HasKey(e => new { e.IdBang, e.VtCot, e.VtDong });

                entity.ToTable("Nd_Bang");

                entity.Property(e => e.IdBang).HasColumnName("Id_Bang");

                entity.Property(e => e.VtCot).HasColumnName("VT_Cot");

                entity.Property(e => e.VtDong).HasColumnName("VT_Dong");

                entity.Property(e => e.NoiDung).HasColumnName("Noi_Dung");

                entity.HasOne(d => d.Bang)
                    .WithMany(p => p.NdBangs)
                    .HasForeignKey(d => d.IdBang)
